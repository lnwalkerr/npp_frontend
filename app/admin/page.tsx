  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-6 flex flex-row flex-wrap gap-6">
        <div className="py-6 flex-1 flex flex-col border border-default-200 dark:border-default-100 rounded-xl bg-background gap-6 shadow-2xl">
          <div className="px-6 font-medium text-foreground">User Growth</div>
